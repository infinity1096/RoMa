...
class ScanNetScene:
    ...
    def __getitem__(self, pair_idx):
        ...
        T1 = self.read_scannet_pose(osp.join(self.scene_root, scene_name, "pose", f"{stem_name_1}.txt"))
        T2 = self.read_scannet_pose(osp.join(self.scene_root, scene_name, "pose", f"{stem_name_2}.txt"))
